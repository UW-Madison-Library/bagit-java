...
public class PathUtilsTest extends PrivateConstructorTest {
  ...
  public void testDecode(){
    ...
    String actualDecoded = PathUtils.decodeFilename(testString, Version.VERSION_0_97);
  ...
  public void testEncode(){
    if(!TestUtils.isExecutingOnWindows()){
      ...
      String actualEncoded = PathUtils.encodeFilename(testPath, Version.VERSION_0_97);
